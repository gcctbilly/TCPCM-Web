                        ...
                        <div className="collapse navbar-collapse d-xl-flex justify-content-xl-end" id="navcol-1" style={{width: '1020.12px',margin: '4px',padding: '0px',color: 'var(--bs-light)'}}>
                            <ul className="navbar-nav">
                                <li className="nav-item">
                                    <Link className="nav-link active" to="/industryPage/home" style={{color: 'var(--bs-light)',fontFamily: 'Almarai, sans-serif'}}>Industry Expert</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link" style={{color: 'var(--bs-warning)',fontFamily: 'Almarai, sans-serif'}}>Professor</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link" to="#" style={{color: 'var(--bs-body-bg)',fontFamily: 'Almarai, sans-serif'}}>Student</Link>
                                </li>
                                <li className="nav-item">
