...
export default class GradeReportBody extends Component {
    render() {
        return (
            <div>
                <section className="contact-clean">
                    <form method="post">
                        <h2 className="text-center">Student Report Grading</h2>
                        <div className="mb-3"><small className="form-text">Report Name</small><input className="form-control" type="text" name="report name"/></div>
                        ...
                        <div className="mb-3"><Link className="btn btn-primary" role="button" to='/professor/grading/report/success'>Comfirm and sign</Link></div>
                    </form>
                </section>
            </div>
        )
